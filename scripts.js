...
(function() {
  ...
  const isProjectPage = path.includes('project-') || path.includes('about.html') || path.includes('journal.html') || path.includes('mddocs.html') || path.includes('figmamake.html') || path.includes('aiprompts.html') || path.includes('intick.html') || path.includes('darkroom.html') || path.includes('claudecode.html');
